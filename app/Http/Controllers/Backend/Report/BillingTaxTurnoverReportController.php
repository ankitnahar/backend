...
class BillingTaxTurnoverReportController extends Controller {
    ...
    public function generateReport(Request $request) {
        ...
        $generateReport = \App\Models\Backend\BillingTaxTurnover::getReportData()->select(DB::raw($selectField));
        ...
        $generateReport = $generateReport->groupBy("e.id", "billing_tax_turnover.id");
        ...
        $generateReport = \App\Models\Backend\BillingTaxTurnover::reportArrangeData($generateReport);
        ...
        if ($request->has('excel') && $request->get('excel') == 1) {
            ...
            return exportExcelsheet($column, 'BillingTaxTurnoverReport', 'xlsx', 'A1:' . $x . '1');
        }
