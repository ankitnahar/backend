...
class TicketReportController extends Controller {
    ...
    public function generateReport(Request $request) {
        ...
        $alias = array("name" => "e", "code" => "e", "created_on" => "ticket", "created_by" => "ticket");
        $fieldArray = array();
        ...
        $generateReport = \App\Models\Backend\Ticket::getReportData()->select(DB::raw($selectField));
        ...
        if ($request->has('search')) {
            ...
            $alias = array("entity_name" => "e", "trading_name" => "e", "billing_name" => "e", "code" => "e", "created_on" => "ticket", "created_by" => "ticket","parent_id" => "e");
        ...
        $generateReport = \App\Models\Backend\Ticket::reportArrangeData($generateReport);
        ...
        if ($request->has('excel') && $request->get('excel') == 1) {
            ...
            return exportExcelsheet($column, 'TicketReport', 'xlsx', 'A1:' . $x . '1');
        }
