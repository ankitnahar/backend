...
class InformationAdditionalDocumentController extends Controller {
   ...
   public function index(Request $request, $id) {
        try {
            ...
            $informationDocument = \App\Models\Backend\InformationAdditionalDocument::with('created_by:id,userfullname,email')
     ...
     public function store(Request $request, $id) {
       // try {
            ...
            $informationDetail = \App\Models\Backend\InformationAdditionalInfo::find($id);
    ...
    public function uploadDocument(Request $request, $id) {
        //try {
        $entityDetail = \App\Models\Backend\InformationAdditionalInfo::leftjoin("information as i","i.id","information_additional_info.information_id")
                ->leftJoin('entity AS e', 'e.id', '=', 'i.entity_id')
                ->select('e.id', 'e.code', 'e.trading_name')
                ->where("information_additional_info.id",$id)->first();
        ...
        if ($file->move($document_path, $fileName)) {
            ...
            $informationDocument = \App\Models\Backend\InformationAdditionalDocument::insert($data);
        }
    ...
    public function downloadDocument(Request $request, $id) {
        //try {
            $infoDocumentDetail = \App\Models\Backend\InformationAdditionalDocument::find($id);
    ...
    public function destroy(Request $request, $id) {
       // try {
            $infoDetail = \App\Models\Backend\InformationAdditionalDocument::find($id);
