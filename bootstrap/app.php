...
//$app->register(provider\ssoServiceProvider::class);
if (env('APP_DEBUG')) $app->register(Barryvdh\Debugbar\LumenServiceProvider::class);


/*
|--------------------------------------------------------------------------
| Add config files to be loaded
|--------------------------------------------------------------------------
|
| Here we will add all the config files which we can access using
| config() function throughout the application
|
*/
$app->configure('pager');
